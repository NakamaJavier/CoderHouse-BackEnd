...
io.on("connection", (socket) => {
    ...
    //Agrego la logica de recepcion y emision del lado del servidor:
...
res.cookie('CookieCoockie', 'Esto es el valor de una cookie',{maxAge: 30000, signed:true}).send('Cookie creada')) //cookie de 1 minuto con firma
